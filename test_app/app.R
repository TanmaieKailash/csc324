...
ui <- fluidPage(
  ...
  navbarPage(
    ...
    tabPanel("About", 
             mainPanel(
               br(),
               h2("Importance of Languages"),
             "By enabling us to communicate with one another, language is what 
             enables social life and helps us build communities. In creating 
             these communities over thousands of years, languages are also a source of 
             collective cultural knowledge. Therefore, it is imperative to study them in order 
             to better understand what we gain from each language, and what we stand to lose 
             in the rapidly homogenising global linguistic landscape.", 
             br(),
             h2("Purpose of App"),
             "India is a country with many languages and cultures. 
             This app will act as an introductory snapshot to the linguistic landscape of India.",
             br(),
             h2("Interesting Insights"),
             "Some insights I have noticed by creating this app are that the Sino-Tibetan languages 
             seem to be spread out along the border between India and China. 
             The Dravidian languages seem to span the southern states of India, 
             while Austro-Asian languages seem to occur to the east of India. 
             Indo-European languages span across the country but it the only language family 
             with languages that occur in the west of India. Finally, the north and south Andamese isolates solely occur 
             on the Andaman and Nicobar islands. The Sino-Tibetan Language family has the 
             greatest linguistic diversity, with it having 54 languages in it. The Indo-European 
             language family has the most number of speakers, despite being the third most 
             linguistically diverse family, and has about a billion speakers.
             Linguistics diversity of a family is not necessarily predictive of number of 
             speakers of the languages in that family.
             Endangered languages seem to occur most frequently along the borders of the country and 
             in regions where there seems to be a confluence of many language families.  
             This may be due to increased competition between the increased number of languages.
             The geographical distribution of each language family,
             Hindi is, by far, the most spoken language in the country.")),
    tabPanel(
      "Indian Languages And Their Language Families",
      mainPanel(tabsetPanel(
        tabPanel(
          "Language families in India and their geographic distribution",
